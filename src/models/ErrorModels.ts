import {ErrorCodesValuesType, ErrorMessagesValuesType} from "../enums";
...
export class Exception extends Error {
    ...
    constructor(
        public message: ErrorMessagesValuesType,
        public status: ErrorCodesValuesType,
        public additionalData: AdditionalData = {},
        public logOnServer: boolean = false
    ) {
        super(message);
        this.status = status;
        this.logOnServer = true;
        if (additionalData) {
